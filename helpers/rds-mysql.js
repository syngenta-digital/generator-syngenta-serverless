...
const _createVersionerFunction = async () => {
    ...
    await file.write_file(`${file.root(true)}application/v1/controller/console/database-versioner.js`, formatted);
    await _dbConnector();
    await _ssm();
...
const _dbConnector = async () => {
    ...
    await file.write_file(`${file.root(true)}application/v1/controller/console/config/dbConnector.js`, formatted);
    return file.copy_directory(`${file.root()}templates/controller/console/helpers`, `${file.root(true)}application/v1/controller/console/config`);
}
...
const _ssm = async () => {
    ...
    await file.write_file(`${file.root(true)}application/v1/controller/console/config/ssm.js`, formatted);
    return file.copy_directory(`${file.root()}templates/controller/console/helpers`, `${file.root(true)}application/v1/controller/console/config`);
}
