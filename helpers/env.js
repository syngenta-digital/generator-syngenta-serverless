...
exports.addEnvVariable = async (variable, env = 'local') => {
    if(!_validate_params(variable, env)) throw new Error('invalid variable or env supplied to addEnvVariable function.');
...
exports.removeEnvVariables = async (variables) => {
    ...
    else if (variables.constructor === Array) {
